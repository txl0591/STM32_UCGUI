...
typedef struct _LcdDriverOps_
{
    void (* Lcd_Init)();
    void (*Lcd_SetPixelIndex)(int x, int y, int PixelIndex);
    unsigned int (*Lcd_GetPixelIndex)(int x, int y); 
    void (*Lcd_XorPixel)(int x, int y);
    void (*Lcd_DrawHLine)(int x0, int y,  int x1, int Color) ;
    void (*Lcd_DrawVLine)(int x, int y0,  int y1, int Color);
    void (*Lcd_FillRect)(int x0, int y0, int x1, int y1, unsigned int Color);
    void (*Lcd_Pic)(int x, int y,int x0, int y0, int BitsPerPixel, int BytesPerLine, const unsigned char* pic, const unsigned short* color);
    void (*Lcd_On)(void);
    void (*Lcd_Off)(void);
}LcdDriverOps;
